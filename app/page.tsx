...
const MENU_ITEMS = [
  ...
  },
  {
    href: '/suppliers',
    title: 'الموردين',
    subtitle: 'إدارة الموردين والحسابات',
    icon: '🤝',
    description: 'بيانات الموردين، الأرصدة، وكشوفات الحساب',
    color: 'from-purple-600 to-pink-600',
  },
  {
    href: '/purchases',
    title: 'المشتريات',
    subtitle: 'فواتير ومردودات المشتريات',
    icon: '🛒',
    description: 'إدخال فواتير المشتريات والمردودات (Onyx Style)',
    color: 'from-orange-500 to-red-500',
  },
  {
    href: '/inventory',
    title: 'المخازن',
    subtitle: 'الجرد والتحويل المخزني',
    icon: '📦',
    description: 'مراقبة الكميات، التكاليف، والتحويلات بين المخازن',
